package starling.display.graphics {
	...
	public class Graphic extends DisplayObject {
		...
		static private const _helpPoint : Point = new Point();
		...
		protected function applyUVMatrix() : void {
			...
			for ( var i : int = 0; i < vertices.length; i += VERTEX_STRIDE ) {
				MatrixUtil.transformCoords( _uvMatrix, vertices[i + 7], vertices[i + 8], _helpPoint );
				vertices[i + 7] = _helpPoint.x;
				vertices[i + 8] = _helpPoint.y;
			}
		}
